![](https://img.shields.io/github/commit-activity/t/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/last-commit/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/release-date/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/repo-size/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/directory-file-count/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/actions/workflow/status/subhamay-bhattacharyya/gitops-minicamp-2024-tf/deploy-stack.yaml)&nbsp;![](https://img.shields.io/github/issues/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/languages/top/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/github/commit-activity/m/subhamay-bhattacharyya/gitops-minicamp-2024-tf)&nbsp;![](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/bsubhamay/b21a193b71079cfd71034ff303e7cae9/raw/59c74804cc330223978deb6252f7c568cc5182ec/gitops-minicamp-2024-tf.json?)
...
1. **Create a New Repo from Template**
   - Use th repository `terraform-template-repo` as a template to create a new repo for your project.

2. **Clone the Repository**
   - Clone the repo to your local machine.
   ```sh
   git@github.com:subhamay-bhattacharyya/<Your Repository Name>.git
   ```
...
3. **Create and Assign Issues**
   ...
   - A feature branch will be automatically created, prefixed with the issue number (e.g., `SB-0001`) generated with pre-defined a prefix and sequence number.

4. **Switch to the Feature Branch**
   - Switch your local branch from `main` to the new feature branch.
   ```sh
   git switch -c feature/SB-0001-initial-release
   git add -A .
   # The git commit message should be prefixed with the issue number
   git commit -m "SB-0001: initial release."
   git push -u origin feature/SB-0001-initial-release
   ```
